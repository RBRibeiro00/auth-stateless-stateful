...
def build_all_applications():
    ...
    threading.Thread(target=build_application,
                     args={"stateless/stateless-auth-api/stateless-auth-api"}).start()
    threading.Thread(target=build_application,
                     args={"stateless/stateless-any-api/stateless-any-api"}).start()
    threading.Thread(target=build_application,
                     args={"stateful/stateful-auth-api/stateful-auth-api"}).start()
    threading.Thread(target=build_application,
                     args={"stateful/stateful-any-api/stateful-any-api"}).start()
