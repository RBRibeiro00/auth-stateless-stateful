package br.com.rbribeiro.microservice.statelessauthapi.infra.exception;
...
public class ExceptionGlobalHandler {
    ...
    public ResponseEntity<?> hancleAuthenticationException(AuthenticationException authenticationException) {
